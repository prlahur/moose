...
PorousFlowMaterialDensityConstBulk::PorousFlowMaterialDensityConstBulk(const InputParameters & parameters) :
    ...
    _density_p0(getParam<Real>("density_P0")),
...
{
  _density_nodal[_qp] = PorousFlowConstantBulkProperties::density(_porepressure_nodal[_qp][_phase_num], _density_p0, _bulk);
}
...
PorousFlowMaterialDensityConstBulk::computeQpProperties()
{
  ...
  _density_nodal[_qp] = PorousFlowConstantBulkProperties::density(_porepressure_nodal[_qp][_phase_num], _density_p0, _bulk);
  _ddensity_nodal_dp[_qp] = PorousFlowConstantBulkProperties::dDensity_dP(_porepressure_nodal[_qp][_phase_num], _density_p0, _bulk);

  /// Density and derivatives wrt pressure at the qps
  _density_qp[_qp] = PorousFlowConstantBulkProperties::density(_porepressure_qp[_qp][_phase_num], _density_p0, _bulk);
  _ddensity_qp_dp[_qp] = PorousFlowConstantBulkProperties::dDensity_dP(_porepressure_qp[_qp][_phase_num], _density_p0, _bulk);
}
