...
{
  _density_nodal[_qp] = PorousFlowIdealGasProperties::density(_porepressure_nodal[_qp][_phase_num], _temperature_nodal[_qp][_phase_num], _molar_mass);
}
...
PorousFlowIdealGas::computeQpProperties()
{
  ...
  _density_nodal[_qp] = PorousFlowIdealGasProperties::density(_porepressure_nodal[_qp][_phase_num], _temperature_nodal[_qp][_phase_num], _molar_mass);
  _ddensity_nodal_dp[_qp] = PorousFlowIdealGasProperties::dDensity_dP(_temperature_nodal[_qp][_phase_num], _molar_mass);
  _ddensity_nodal_dt[_qp] = PorousFlowIdealGasProperties::dDensity_dT(_porepressure_nodal[_qp][_phase_num], _temperature_nodal[_qp][_phase_num], _molar_mass);

  /// Density and derivatives wrt pressure and temperature at the qps
  _density_qp[_qp] = PorousFlowIdealGasProperties::density(_porepressure_qp[_qp][_phase_num], _temperature_qp[_qp][_phase_num], _molar_mass);
  _ddensity_qp_dp[_qp] = PorousFlowIdealGasProperties::dDensity_dP(_temperature_qp[_qp][_phase_num], _molar_mass);
  _ddensity_qp_dt[_qp] = PorousFlowIdealGasProperties::dDensity_dT(_porepressure_qp[_qp][_phase_num], _temperature_qp[_qp][_phase_num], _molar_mass);
}
