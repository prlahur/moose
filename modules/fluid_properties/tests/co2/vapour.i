# Test vapour pressure, saturated vapour density and saturated liquid density
...
# relation of cabon dioxide II. Saturated-liquid and saturated-vapour densities and
# the vapour pressure along the entire coexstance curve, J. Chem. Thermo. 22 (1990)
#
...
# Vapour density (kg.m^3)  |  14.0017  |  39.5048  |  382.30
...
# Vapour density (kg.m^3)  |  13.9958  |  39.4981  |  383.093
...
[AuxKernels]
  [./pvap]
    type = MaterialRealAux
     variable = pvap
     property = vapour_pressure
  [../]
  [./rhovap]
    type = MaterialRealAux
     variable = rhovap
     property = saturated_vapour_density
  [../]
  [./rhosat]
    type = MaterialRealAux
     variable = rhosat
