...
public:
  ...
  /**
   * Helper method to give density of water from the water FluidProperties
   * UserObject.
   *
   * @param pressure fluid pressure (Pa)
   * @param temperature fluid temperature (K)
   ...
   */
  Real rhoWater(Real pressure, Real temperature) const;
   ...
   * @param temperature halite temperature (K)
   * @return density (kg/m^3)
   */
  Real rhoHalite(Real pressure, Real temperature) const;

  /**
   * Isobaric heat capacity of halite (solid NaCl)
   * From Driesner, The system H2O-NaCl. Part II: Correlations for molar volume,
   * enthalpy, and isobaric heat capacity from 0 to 1000 C, 1 to 500 bar, and 0
   * to 1 Xnacl, Geochimica et Cosmochimica Acta 71, 4902-4919 (2007).
   *
   ...
   * @return isobaric heat capacity (kJ/kg/K)
   */
  Real cpHalite(Real pressure, Real temperature) const;

  /**
   * Enthalpy of halite (solid NaCl)
   * From Driesner, The system H2O-NaCl. Part II: Correlations for molar volume,
   * enthalpy, and isobaric heat capacity from 0 to 1000 C, 1 to 500 bar, and 0
   * to 1 Xnacl, Geochimica et Cosmochimica Acta 71, 4902-4919 (2007).
   *
   ...
   * @return enthalpy (kJ/kg)
   */
  Real hHalite(Real pressure, Real temperature) const;
